...
master = mavutil.mavlink_connection('udpin:192.168.0.215:14555',source_component=TARGET_COMP)
...
while not rospy.is_shutdown():
    try:
        ...
        if(protocol):
            ...
            protocol=False
        if(type(msg)==mavutil.mavlink.MAVLink_mission_item_int_message):
                # print(msg.seq)
                # print(MISSIN_COUNT)
            ...
            if(msg.command==519):
                ...
                if(msg.param1==0.0):
                    ...
                    flight.engine_disarm()
        elif(type(msg)==ardupilotmega.MAVLink_mission_count_message):
